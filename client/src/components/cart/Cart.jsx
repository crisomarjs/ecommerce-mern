  ...
  return (
    <div className="show-cart-container">
      <div className="show-cart-wrapper">
        {total > 0 && <h2 className='show-cart-title'>Carrito</h2>}
        <div className="show-cart-items">
          {products?.length === 0 ? (
            <h1 className='no-product'>No hay productos agregados</h1>
          ): (
        ...
        <Link to="/address" onClick={handleCloseCart} className="checkOutBtn">Proceder a pagar</Link>
        </>
        }
        {total > 0 && (
